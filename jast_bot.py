...
def menu():
    return ReplyKeyboardMarkup([
        ...
        [KeyboardButton("Psixolog bilan boglaning")]
    ], resize_keyboard=True)async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
...
def main():
    ...
    conv = ConversationHandler(
        ...
        states={
            ...
            MOOD: [CallbackQueryHandler(mood_cb, pattern="^mood_")],
